...
export default function AboutPage() {
  const students = [
    { name: 'Stuvat', role: 'Student Developer', photo: stuvat },
    { name: 'Inessa', role: 'Student Developer', photo: inessa },
    { name: 'Zoey', role: 'Student Developer', photo: null },
    { name: 'Evan', role: 'Student Developer', photo: evan },
  ]

  const sponsor = { name: 'Malte', role: 'Project Sponsor — LUMA Earth' }
  ...
  return (
    <div style={{ fontFamily: "'DM Serif Display', Georgia, serif", background: '#080c0a', color: '#e8ede9', minHeight: '100vh', padding: '80px' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div className="mono" style={{ fontSize: 11, color: '#10b981', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 16 }}>About Us</div>
        <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 400, letterSpacing: '-0.02em', marginBottom: 16, lineHeight: 1.05 }}>
          The team behind<br /><em style={{ color: '#10b981' }}>LUMA Biome.</em>
        </h1>
        <p className="mono" style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', maxWidth: 540, lineHeight: 1.8, marginBottom: 80, fontWeight: 300 }}>
        ...
        {/* Student grid */}
        <div className="mono" style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 24 }}>Student Team</div>
              ...
              {member.photo ? (
                ...
                <div style={{ aspectRatio: '3/4', background: 'rgba(255,255,255,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <span className="mono" style={{ fontSize: 10, color: 'rgba(255,255,255,0.15)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Photo</span>
                  </div>
                </div>
              )}
        ...
        {/* Sponsor */}
        <div className="mono" style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 24 }}>Project Sponsor</div>
