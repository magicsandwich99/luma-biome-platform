...
const projects = [
  ...
  },
  {
    ...
    client: 'JOPE AG',
    description: 'A challenging transformation of a severely compacted courtyard in Berlin-Neukölln, completed in spring 2024. The site suffered from years of compaction — heavy rain had turned the ground into a mud landscape with no drainage. LUMA used a soil lance to mechanically break up the impacted layers and restored the drainage capacity with a targeted fill substrate. With the soil rehabilitated, LUMA planted mini-forest elements alongside a rich wild perennial palette, and seeded the lawn areas with native wildflower species — the grass is now mown only minimally to let wild species establish. Corten steel bed edging provides a clean structural contrast between maintained seating lawns and the wilder planting zones — a deliberate design answer to the tension between "tidy" and "wild" that always arises on public-facing sites. On-site nettle fermentation juice is produced directly at the project location as a chemical-free liquid fertiliser. A dry stone wall was built and planted with medicinal and useful herbs. The core lesson of this project: consulting, planning, and installation are only the enablers. It is the long-term stewardship contract that actually grows the ecosystem.',
    descriptionDE: 'Eine anspruchsvolle Umgestaltung eines stark verdichteten Innenhofs in Berlin-Neukölln, abgeschlossen im Frühjahr 2024. Die Fläche litt unter jahrelanger Bodenverdichtung — Starkregen hatte den Boden in eine Schlammlandschaft verwandelt, die jede Drainage verhinderte. LUMA lockerte die verdichteten Schichten mit einer Bodenlanze mechanisch auf und stellte die Drainagefähigkeit mit einem gezielten Füllsubstrat wieder her. Mit dem sanierten Boden wurden Miniwaldinseln neben einem reichen Wildstauden-Spektrum gepflanzt; die Rasenflächen wurden mit heimischen Wildkräutern eingesät und werden seitdem nur minimal gemäht. Cortenstahl-Beetbegrenzungen schaffen einen klaren strukturellen Kontrast zwischen gepflegten Aufenthaltsflächen und den wilderen Pflanzabschnitten — eine bewusste Designantwort auf die Spannung zwischen „ordentlich" und „wild", die auf öffentlichkeitswirksamen Flächen immer wieder entsteht. Brennnesseljauche wird direkt vor Ort als chemiefreier Flüssigdünger angesetzt. Eine Trockenmauer wurde errichtet und mit Heil- und Nutzpflanzen bepflanzt. Die Kernlehre dieses Projekts: Beratung, Planung und Pflanzung sind nur die Enabler. Das Ökosystem entsteht erst durch die langfristige Pflege.',
